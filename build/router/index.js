...
router.get("/getnotification/:userId", controllers_1.getNotifications);
router.get("/gettempletes", controllers_1.getContractTemplates);
router.post("/signdocument", controllers_1.signDocument);
...
router.delete('/deletenotification', controllers_1.deleteNotification);
